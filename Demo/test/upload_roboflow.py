...
def main():
    ...
    print()
    print("다음 (Roboflow 웹에서 사람이 할 일):")
    print("  1. B4(파랑 원) 박스 추가 — v1이 못 잡아 프리라벨이 전무하다")
    print("  2. 배경 오탐 삭제 — 흰 접시·제빙기 뚜껑이 B2로 잡힌 것")
    print("  3. 정반사 프레임: B1·B3가 B2로 오분류된 것 수정")
    print("     ※ 정답은 **진짜 버튼 정체**다. 노란 버튼이 하얗게 보여도 B1.")
    print("  4. 저조도 세션: 놓친 B3·EMO 보충")
    print()
