...
# 🔑 실측된 오인식을 그대로 받아들인다.
#    §10.51(폰 녹음) — 가디건 · 가디얀 · 가디현
#    2026-09-07 실HW(ESP32 마이크) — 「가디연」 이 새로 나왔다. 「가디안」·「카디언」은
#    같은 계열로 미리 넣어 둔다(ㅓ↔ㅏ, ㄱ↔ㅋ 은 STT 가 자주 흔들리는 자리다).
#    🔴 촬영 중 다른 문자열로 들리면 **여기에 그대로 추가**한다 — 그것이 이 설계의 방식이다.
WAKE_WORDS = ("가디언", "가디건", "가디얀", "가디현", "가디연", "가디안", "카디언")

# 공구 질문 — 「보이다」 계열 또는 「공구」 + 「무엇」 계열이 함께 있으면 그것으로 본다.
# 실HW 에서 "앞에 보이는 게 뭐야?" 가 「아보이는게뭐야」·「아배드민게뭐야」로 튀었다.
# 「보이」가 살아 있으면 잡히지만 그것마저 날아가면 못 잡는다 — 힌트를 넓힌다.
_TOOL_HINTS = ("보이", "보여", "보인", "공구", "도구", "이거", "이게")
_WHAT_HINTS = ("뭐", "무엇", "뭔")
